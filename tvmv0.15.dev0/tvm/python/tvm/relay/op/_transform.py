...
@_reg.register_compute("swiglu_ffn")
def compute_swiglu_ffn(attrs, inputs, output_type):
    """Compute definition of swiglu_ffn"""
    return [topi.swiglu_ffn(inputs[0], inputs[1], inputs[2], inputs[3], inputs[4], attrs.gate_bias_flag, attrs.up_bias_flag)]


_reg.register_strategy("swiglu_ffn", strategy.swiglu_strategy)
_reg.register_shape_func("swiglu_ffn", False, broadcast_shape_func)
